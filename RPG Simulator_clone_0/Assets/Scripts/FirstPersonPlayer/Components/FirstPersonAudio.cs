...
public class FirstPersonAudio : MonoBehaviour
{
    ...
    Vector2 CurrentCharacterPosition => new(character.networkTransform.transform.position.x, character.networkTransform.transform.position.z);
    ...
    void Reset()
    {
        ...
        NetworkTransform parentTransform = GetComponentInParent<NetworkTransform>();
        character = GetComponentInParent<FirstPersonMovement>();
        groundCheck = (parentTransform ?? networkTransform).GetComponentInChildren<GroundCheck>();
