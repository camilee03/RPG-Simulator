...
public class ProcessVideo : NetworkBehaviour
{
    ...
    [SerializeField, Range(0f, 100f)] float minChangePercent = 0.5f;
    ...
    [SerializeField, Range(0, 255)] int pixelDiffThreshold = 10;
    ...
    [SerializeField] int maxFramesBetweenKeyframes = 15;
    ...
    private void Start()
    {
        ...
        localConnection.OnIceCandidate += (e) => {
            Debug.Log($"Got local ICE candidate: {e.Candidate}");
        };

        remoteConnection.OnIceCandidate = e =>
        {
            Debug.Log($"Got remote ICE candidate: {e.Candidate}");
        };
